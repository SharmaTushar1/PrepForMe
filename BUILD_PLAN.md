...
- **Resume PDF is now Chromium templates (5 Aug).** Classic/Compact HTML → `/api/render-resume-pdf`. Hand-rolled PDF path retired for Generate/Tailor. See PROJECT.md §14.
